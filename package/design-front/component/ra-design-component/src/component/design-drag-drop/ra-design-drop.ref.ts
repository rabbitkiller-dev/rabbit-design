...
import {moveItemInArray, DragDropRegistry} from '../cdk-drag-drop';
 ...
 * @docs-private
 */
export class RaDesignDropRef<T = any> {
   ...
   */
  enterPredicate: (drag: RaDesignDragRef, drop: RaDesignDropRef) => boolean = () => true;
   ...
   */
  entered = new Subject<{ item: RaDesignDragRef, container: RaDesignDropRef }>();

  /**
   * Emits when the user removes an item from the container
   * by dragging it into another container.
   */
  exited = new Subject<{ item: RaDesignDragRef, container: RaDesignDropRef }>();
  ...
  dropped = new Subject<{
    ...
    container: RaDesignDropRef,
    previousContainer: RaDesignDropRef,
   ...
   */
  private _draggables: RaDesignDragRef[];

  private _siblings: RaDesignDropRef[] = [];
  ...
  constructor(
    ...
    private _dragDropRegistry: DragDropRegistry<RaDesignDragRef, RaDesignDropRef>,
    _document: any,
   ...
   */
  enter(item: RaDesignDragRef, pointerX: number, pointerY: number): void {
   ...
   */
  exit(item: RaDesignDragRef): void {
    this._reset();
   ...
   */
  drop(item: RaDesignDragRef, currentIndex: number, previousContainer: RaDesignDropRef,
   ...
   */
  withItems(items: RaDesignDragRef[]): this {
   ...
   */
  connectedTo(connectedTo: RaDesignDropRef[]): this {
   ...
   */
  _sortItem(item: RaDesignDragRef, pointerX: number, pointerY: number,
   ...
   */
  _getSiblingContainerFromPosition(item: RaDesignDragRef, x: number, y: number): RaDesignDropRef | null {
